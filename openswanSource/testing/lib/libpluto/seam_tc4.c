/* test case 4 - DH operation, SHA1 + AES, but with unequal nonces */
u_int16_t     tc4_oakleygroup  = OAKLEY_GROUP_MODP1536;
oakley_auth_t tc4_auth         = AUTH_ALGORITHM_HMAC_SHA1;
oakley_hash_t tc4_hash         = OAKLEY_SHA1;
enum phase1_role tc4_init      = INITIATOR;

unsigned char tc4_gi[] = {
...
unsigned int tc4_gi_len = sizeof(tc4_gi);

unsigned char tc4_gr[] = {
...
unsigned int tc4_gr_len = sizeof(tc4_gr);

unsigned char tc4_ni[] = {
 0xb5, 0xce, 0x84, 0x19,  0x09, 0x5c, 0x6e, 0x2b,  
 0x6b, 0x62, 0xd3, 0x05,  0x53, 0x05, 0xb3, 0xc4,  
};
unsigned int tc4_ni_len = sizeof(tc4_ni);

unsigned char tc4_nr[] = {
 0x47, 0xe9, 0xf9, 0x25,  0x8c, 0xa2, 0x38, 0x58,  
 0xf6, 0x75, 0xb1, 0x66,  0xb0, 0x2c, 0xc2, 0x92,  
 0x9e, 0xd4, 0x9d, 0xf1,  0xcb, 0x68, 0x1e, 0x7f,
 0x30, 0x68, 0x60, 0x30,  0x74, 0x53, 0xb0, 0x15
};
unsigned int tc4_nr_len = sizeof(tc4_nr);

unsigned char tc4_icookie[] = {
 0x75, 0x46, 0xd3, 0xd6,  0xea, 0x09, 0xf7, 0xdf,  
};
unsigned int tc4_icookie_len = sizeof(tc4_icookie);

unsigned char tc4_rcookie[] = {
 0x61, 0xa6, 0x78, 0x6a,  0x41, 0xea, 0x48, 0x06,  
};
unsigned int tc4_rcookie_len = sizeof(tc4_rcookie);

unsigned char tc4_secret[] = {
...
unsigned int tc4_secret_len = sizeof(tc4_secret);

unsigned char tc4_results_shared[]= {
