...
if [ ! -x $HOME/stuff/bin/tcpdump ]
then
    cd ${BUILDTOP}
    curl http://www.ca.tcpdump.org/release/libpcap-1.7.4.tar.gz | tar xzf -
    curl http://www.ca.tcpdump.org/release/tcpdump-4.7.4.tar.gz | tar xzf -
