#ifndef __seam_gi_3des_md5_c__
#define __seam_gi_3des_md5_c__
...
/* test case 102 - DH operation, SHA1 + 3DES */
u_int16_t     __tc102_oakleygroup  = OAKLEY_GROUP_MODP2048;
oakley_auth_t __tc102_auth         = AUTH_ALGORITHM_HMAC_MD5;
oakley_hash_t __tc102_hash         = OAKLEY_MD5;
enum phase1_role __tc102_init      = INITIATOR;

unsigned char __tc102_gi[] = {
...
unsigned int __tc102_gi_len = sizeof(__tc102_gi);

unsigned char __tc102_gr[] = {
...
unsigned int __tc102_gr_len = sizeof(__tc102_gr);

unsigned char __tc102_ni[] = {
0x3c, 0xd5, 0x15, 0x14,  0x50, 0xab, 0x73, 0x9a,  0xc8, 0xac, 0x54, 0x1c,  0x0d, 0xe6, 0xbc, 0x04,
};
unsigned int __tc102_ni_len = sizeof(__tc102_ni);

unsigned char __tc102_nr[] = {
0x00, 0x84, 0xb6, 0x7e,  0xd1, 0xb6, 0xd1, 0x52,  0x89, 0x0e, 0xd7, 0x1c,  0x74, 0xb9, 0x26, 0xe4,
};
unsigned int __tc102_nr_len = sizeof(__tc102_nr);

unsigned char __tc102_icookie[] = {
0x8a, 0x44, 0x87, 0x03,  0xba, 0x72, 0x90, 0x75,
};
unsigned int __tc102_icookie_len = sizeof(__tc102_icookie);

unsigned char __tc102_rcookie[] = {
0x55, 0x68, 0x7f, 0x55,  0x86, 0xc2, 0x97, 0x2a,
};
unsigned int __tc102_rcookie_len = sizeof(__tc102_rcookie);

unsigned char __tc102_secret[] = {
...
unsigned int __tc102_secret_len = sizeof(__tc102_secret);

unsigned char __tc102_secretr[] = {
0xe7, 0xa6, 0x91, 0x6a,  0x99, 0xf7, 0x2a, 0x24,  0x24, 0xac, 0xba, 0xda,  0x5c, 0xcd, 0x57, 0x3e,
0xae, 0x01, 0xcd, 0x21,  0x49, 0x8d, 0x16, 0x24,  0xfb, 0xa7, 0x41, 0x72,  0xa0, 0x77, 0xbf, 0xa3,
};
unsigned int __tc102_secretr_len = sizeof(__tc102_secretr);

unsigned char __tc102_results_shared[]= {
