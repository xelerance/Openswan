...
#echo 1 >/proc/sys/net/ipsec/debug_xmit
#echo 1 >/proc/sys/net/ipsec/debug_verbose
...
(cd /tmp && l2tpd -c /testing/pluto/mast-l2tp-02/east.l2tpd.conf -D 2>/tmp/l2tpd.log ) &
echo done
