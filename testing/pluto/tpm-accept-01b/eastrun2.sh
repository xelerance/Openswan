...
/usr/local/libexec/ipsec/whack --name west--east-psk-3des --encrypt --tunnel \
	...
	--ikealg "3des" --impair-die-oninfo \
	--keyingtries "0"    

/usr/local/libexec/ipsec/whack --name west--east-psk-3des --initiate
