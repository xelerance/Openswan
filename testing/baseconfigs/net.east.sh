...
if [ -n "$UML_east_CTL" ]
then
    net_eth0="eth0=daemon,10:00:00:dc:bc:ff,unix,$UML_east_CTL";
elif [ -n "$UML_private_CTL" ]
then
    net_eth0="eth0=daemon,10:00:00:dc:bc:ff,unix,$UML_private_CTL";
else
...
if [ -n "$UML_public_CTL" ]
then
    net_eth1="eth1=daemon,10:00:00:64:64:23,unix,$UML_public_CTL";
else
...
if [ -n "$UML_admin_CTL" ]
then
    net_eth2="eth2=daemon,10:00:00:32:64:23,unix,$UML_admin_CTL";
else
