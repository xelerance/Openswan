...
const oid_t oid_names[] = {
  ...
  {          0x07,             0, 1, "id-pkix"                },  /*  93 */
  {            0x0A,           0, 1, "id-aca"                 },  /*  94 */
  {              0x01,        96, 0, "authenticationInfo"     },  /*  95 */
  {              0x02,        97, 0, "accessIdentity"         },  /*  96 */
  {              0x03,        98, 0, "chargingIdentity"       },  /*  97 */
  {              0x04,         0, 0, "group"                  },  /*  98 */
  {  0x0E,                   103, 1, "oiw"                    },  /*  99 */
  {    0x03,                   0, 1, "secsig"                 },  /* 100 */
  {      0x02,                 0, 1, "algorithms"             },  /* 101 */
  {        0x1A,               0, 0, "id-SHA-1"               },  /* 102 */
  {  0x24,                     0, 1, "TeleTrusT"              },  /* 103 */
  {    0x03,                   0, 1, "algorithm"              },  /* 104 */
  {      0x03,                 0, 1, "signatureAlgorithm"     },  /* 105 */
  {        0x01,               0, 1, "rsaSignature"           },  /* 106 */
  {          0x02,           108, 0, "rsaSigWithripemd160"    },  /* 107 */
  {          0x03,           109, 0, "rsaSigWithripemd128"    },  /* 108 */
  {          0x04,             0, 0, "rsaSigWithripemd256"    },  /* 109 */
  {0x60,                       0, 1, ""                       },  /* 110 */
  {  0x86,                     0, 1, ""                       },  /* 111 */
  {    0x48,                   0, 1, ""                       },  /* 112 */
  {      0x01,                 0, 1, "organization"           },  /* 113 */
  {        0x65,             121, 1, "gov"                    },  /* 114 */
  {          0x03,             0, 1, "csor"                   },  /* 115 */
  {            0x04,           0, 1, "nistalgorithm"          },  /* 116 */
  {              0x02,         0, 1, "hashalgs"               },  /* 117 */
  {                0x01,     119, 0, "id-SHA-256"             },  /* 118 */
  {                0x02,     120, 0, "id-SHA-384"             },  /* 119 */
  {                0x03,       0, 0, "id-SHA-512"             },  /* 120 */
  {        0x86,               0, 1, ""                       },  /* 121 */
  {          0xf8,             0, 1, ""                       },  /* 122 */
  {            0x42,           0, 1, ""                       },  /* 123 */
  {              0x01,         0, 1, ""                       },  /* 124 */
  {                0x01,     126, 0, "nsCertType"             },  /* 125 */
  {                0x03,     127, 0, "nsRevocationUrl"        },  /* 126 */
  {                0x0d,       0, 0, "nsComment"              }   /* 127 */
};
