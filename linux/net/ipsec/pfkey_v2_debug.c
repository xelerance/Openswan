...
static char *pfkey_sadb_ext_strings[]={
  ...
  /* NAT_TRAVERSAL */
  "X-NAT-T-type",                 /* K_SADB_X_EXT_NAT_T_TYPE         26 */
  "X-NAT-T-sport",                /* K_SADB_X_EXT_NAT_T_SPORT        27 */
  "X-NAT-T-dport",                /* K_SADB_X_EXT_NAT_T_DPORT        28 */
  "X-NAT-T-OA",                   /* K_SADB_X_EXT_NAT_T_OA           29 */
};
