...
enum whack_CBOR_actions {
    ...
    WHACK_ROUTE    =CDDL_WHACK_ROUTE,
    WHACK_UNROUTE  =CDDL_WHACK_UNROUTE,
    WHACK_INITIATE =CDDL_WHACK_INITIATE,
    WHACK_INITIATE_OPPO=CDDL_WHACK_INITIATE_OPPO,
    WHACK_TERMINATE=CDDL_WHACK_TERMINATE,
    WHACK_ADD_KEY  =CDDL_WHACK_ADD_KEY,
    WHACK_DELETE   =CDDL_WHACK_DELETE,
    WHACK_LISTEN   =CDDL_WHACK_LISTEN,
    WHACK_UNLISTEN =CDDL_WHACK_UNLISTEN,
    WHACK_LIST     =CDDL_WHACK_LIST,
    WHACK_PURGE_OCSP=CDDL_WHACK_PURGE_OCSP,
    WHACK_REREAD   =CDDL_WHACK_REREAD,
    WHACK_MYID     = CDDL_WHACK_MYID,
    WHACK_DELETESTATE=CDDL_WHACK_DELETESTATE,
    WHACK_CRASHPEER=CDDL_WHACK_CRASHPEER,
    WHACK_ASYNC    =CDDL_WHACK_ASYNC,
    WHACK_NOOP     =CDDL_WHACK_NOOP,
};
